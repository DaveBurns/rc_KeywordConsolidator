...
Edit History:       2010-10-XX: Created by Rob Cole - based on lua distribution source code.

------------------------------------------------------------------------------------

Notes:              Potential use: To catch potential coding mistakes AND to help ensure compatibility of Lr3/2 plugins
                    with Lr2, whilst running in Lr3.
